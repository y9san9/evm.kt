...
/**
 * Main class to execute evm requests that can fail with [EvmIO.Exception]. It
 * is safe tho, as creation of [EvmExecutor] guarantees you called
 * [EvmClient.use] that sets up an exception trap.
 */
